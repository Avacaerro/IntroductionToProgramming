...
# There is no explicit return of string when the person string object is compared.
# When the get_quote method ends it returns nil when person is 'Confucius' or 'Yoda'. 
