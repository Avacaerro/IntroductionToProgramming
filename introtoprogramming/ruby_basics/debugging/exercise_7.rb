...
# The issue is that in the last block we are assigning balance a new value
# at each iteration. The final value is the march balance. We can fix this
# by using += to add to the balance variable.
